	...
	<div id="page-wrapper">
		...
		<div id="sidebar-wrapper">
			<ul class="sidebar-nav">
				...
				<hr />
				<li style="background-color: white; color: black;"><a onclick="goMain()" id="Main" class="sidebar-brand">메인화면</a></li>
				<hr />
				<li><a onclick="goUser()" id="User" class="sidebar-brand">유저 리스트</a></li>
				<hr />
				<li><a onclick="goBoard()" id="Board" class="sidebar-brand">게시물 리스트</a></li>
				<hr />
				<li><a onclick="goRepProc()" id="RepProc" class="sidebar-brand">신고 처리 결과 리스트</a></li>
				<hr />
				<li><a onclick="goNotice()" id="Notice" class="sidebar-brand">공지 전송</a></li>
				<hr />
				<br />
				<br />
				<br />
				...
				<br />
				<hr />
				<li><a onclick="goChiefAdmin()" id="chiefAdmin" class="sidebar-brand">최고 관리자</a></li>
					...
					<div class="row" id="divProfile">
						...
						<div class="col-sm-8" style="text-align: left;">
							<h4>
								...
								<h4>
									<strong>권한:</strong> 관리자 ${mem_num}번
								</h4>
								<br />
								<hr />
								<br />
...
function createBoardTable(list, dateStrs){
	...
	function goMain() {
		...
		$(".sidebar-brand").css({"background-color":"black", "color" : "white"});
	...
	function goUser() {
		...
		$(".sidebar-brand").css({"background-color":"black", "color" : "white"});
		$("#User").css({"background-color":"white", "color" : "black"});
	}
	...
	function goBoard() {
		...
		$(".sidebar-brand").css({"background-color":"black", "color" : "white"});
		$("#Board").css({"background-color":"white", "color" : "black"});
	}
	...
	function goRepProc() {
		...
		$(".sidebar-brand").css({"background-color":"black", "color" : "white"});
		$("#RepProc").css({"background-color":"white", "color" : "black"});
	}
	...
	function goNotice() {
		...
		$(".sidebar-brand").css({"background-color":"black", "color" : "white"});
		$("#Notice").css({"background-color":"white", "color" : "black"});
	}
	
	function goChiefAdmin() {
		$('#Context').empty();
		$('#Context').load("resources/jsp/chiefAdmin.jsp");
		$(".sidebar-brand").css({"background-color":"black", "color" : "white"});
		$("#chiefAdmin").css({"background-color":"white", "color" : "black"});
	}

	
	$(document).ready(goMain());
	desList();
	admList();
	recJoinList();
	boardList();
