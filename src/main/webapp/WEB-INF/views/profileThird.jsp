...
<body>
   <form action="/" method="post" enctype="multipart/form-data">
      ...
      <div class="my">
         <table>
         <c:if test="${post_bookList.size()>0}">
            <tr>
               <td>
                  <c:forEach items="${post_bookList}" var="file">
      ...
      <div class="profil">
         ...
         <div>
            <br>
            <button type="button" onclick="location.href='profileEdit?mem_num=${info.mem_num}'">프로필 편집</button>
